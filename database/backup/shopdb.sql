...
INSERT INTO `deletedmembertbl` VALUES ('Dang','당탕이','경기도 부천시 중동','2024-03-08');
...
INSERT INTO `membertbl` VALUES ('figure','연아','서울시 강남구 역삼동'),('Han','한주현','인천 남구 주안동'),('Jee','지운이','서울 은평구 증산동'),('Sang','상길이','경기 성남시 분당구');
...
INSERT INTO `producttbl` VALUES ('냉장고',5,'2023-02-01','대우',22),('세탁기',20,'2021-09-01','LG',3),('컴퓨터',10,'2021-01-01','삼성',17);
...
-- Dump completed on 2024-03-08 16:22:25
